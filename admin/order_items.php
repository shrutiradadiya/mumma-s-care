...
$order_items_result = $conn->query("SELECT * FROM order_items");
...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .data-table th { background:#f8fafc; padding:12px 20px; font-size:12px; font-weight:600; color:#888; text-transform:uppercase; letter-spacing:0.5px; text-align:center; }
        .data-table td { padding:13px 20px; font-size:14px; border-bottom:1px solid #f0f2f5; color:#444; text-align:center; }
...
<div class="sidebar">
    ...
    <nav>
        ...
        <a href="order_items.php" class="active"><i class="fas fa-list-ul"></i><span>Order Items</span></a>
...
<div class="main-content">
    <div class="topbar">
        <div>
            <h1>Order Items</h1>
            <p>Detailed breakdown of each order</p>
        </div>
    ...
    <div class="page-body">
        <div class="panel">
            <div class="panel-header">
                <h3><i class="fas fa-list-ul" style="color:#e91e8c;margin-right:8px;"></i>All Order Items</h3>
            </div>
                ...
                <tbody>
                    <?php if ($order_items_result && $order_items_result->num_rows > 0): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="delete_order_item.php?id=<?= $row['id'] ?>" onclick="return confirm('Delete this item?')" class="btn-delete">Delete</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr><td colspan="7" style="text-align:center;padding:30px;color:#aaa;">No order items found.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
