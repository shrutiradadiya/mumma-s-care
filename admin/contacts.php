...
$contact_result = $conn->query("SELECT id, name, email, message FROM contact_form");
...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .data-table td { padding:13px 20px; font-size:14px; border-bottom:1px solid #f0f2f5; color:#444; vertical-align:top; }
        .data-table tr:last-child td { border-bottom:none; }
        .data-table tr:hover td { background:#fafafa; }
        .msg-text { max-width:360px; white-space:pre-wrap; word-break:break-word; }
...
<div class="sidebar">
    ...
    <nav>
        ...
        <a href="contacts.php" class="active"><i class="fas fa-envelope"></i><span>Contacts</span></a>
    </nav>
    ...
    <div class="page-body">
        <div class="panel">
            <div class="panel-header">
                <h3><i class="fas fa-envelope-open-text" style="color:#e91e8c;margin-right:8px;"></i>All Messages</h3>
            </div>
                ...
                <tbody>
                    <?php if ($contact_result && $contact_result->num_rows > 0): ?>
                        ...
                        <tr>
                            ...
                            <td><div class="msg-text"><?= htmlspecialchars($row['message']) ?></div></td>
                            <td>
                                <a href="contacts.php?delete=<?= $row['id'] ?>" onclick="return confirm('Delete this message?')" class="btn-delete">Delete</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr><td colspan="5" style="text-align:center;padding:30px;color:#aaa;">No contact messages found.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
